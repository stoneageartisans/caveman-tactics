...
class UserInterface
{
    public:
        ...
        ~UserInterface();
        void flash_text();
        IGUIElement* getWidget( s32 WIDGET_ID );
    ...
    private:
        ...
        IGUIButton*            button_options_done;
        IGUIButton*            button_resume;     
        IGUIButton*            button_start;
        IGUICheckBox*          checkbox_music;
        ...
        map<s32, IGUIElement*> widgets;
        f32                    z_offset;
        
        void dispose();
        void hide_character_screen();
        void hide_main_menu();
        void hide_options_screen();
        ...
        void initialize_options_screen();
